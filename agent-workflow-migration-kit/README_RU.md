...
4. `prompts/03_add_orchestration_scripts_contract.txt`
5. `prompts/04_define_ci_and_review_loop.txt`
6. `prompts/05_define_delivery_and_smoke_flow.txt`
7. `prompts/06_run_first_test_feature_through_full_loop.txt`
