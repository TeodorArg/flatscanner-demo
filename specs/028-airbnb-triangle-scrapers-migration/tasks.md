...
- [x] Add dedicated Airbnb review-source configuration during the migration
- [x] Introduce Airbnb review-source fetching abstraction (`src/analysis/reviews/airbnb_source.py` -- `AirbnbReviewSource`)
- [x] Update Airbnb review normalization for flat per-review schemas (`normalize_from_actor_items()` + `localizedReviewerLocation` support in `AirbnbReviewNormalizer`)
